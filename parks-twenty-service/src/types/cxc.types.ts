...
// Pipeline CxC: refleja el handoff Legal → cobranza hasta salida
...
export type CxcEscalacionInpc = {
  ...
  rentaNueva: number;
  estatus: 'Pendiente' | 'Notificado' | 'Aceptado' | 'En disputa' | 'Resuelto';
...
export type CxcAccount = {
  ...
  // Seguimiento activo que el ejecutivo marca en plataforma
