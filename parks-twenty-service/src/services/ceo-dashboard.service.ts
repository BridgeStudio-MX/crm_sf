    ...
    ocupacionPorParque: [
      {
        ...
        region: 'Occidente',
        metrosRentados: 68_401,
        metrosRentables: 72_000,
        porcentajeOcupacion: 95.0,
        variacionMensualPts: 0.8,
      },
      {
        parqueId: 'parque-salto',
        parqueNombre: 'El Salto Park III',
        region: 'Occidente',
        metrosRentados: 101_885,
        metrosRentables: 198_000,
        porcentajeOcupacion: 51.5,
        variacionMensualPts: -1.4,
      },
      {
        parqueId: 'parque-tmex',
        parqueNombre: 'T-MexPark',
        region: 'Centro',
        metrosRentados: 66_382,
        metrosRentables: 220_000,
        porcentajeOcupacion: 30.2,
        variacionMensualPts: 0.3,
      },
      {
        parqueId: 'parque-toluca',
        parqueNombre: 'Toluca Parks III',
        region: 'Centro',
        metrosRentados: 60_555,
        metrosRentables: 95_000,
        porcentajeOcupacion: 63.7,
        variacionMensualPts: 1.1,
      },
      {
        parqueId: 'parque-tulti',
        parqueNombre: 'TultiPark II',
        region: 'Centro',
        metrosRentados: 47_256,
        metrosRentables: 54_000,
        porcentajeOcupacion: 87.5,
        variacionMensualPts: 0.6,
      },
      {
        parqueId: 'parque-tlane',
        parqueNombre: 'TlanePark IV',
        region: 'Centro',
        metrosRentados: 45_725,
        metrosRentables: 48_000,
        porcentajeOcupacion: 95.3,
        variacionMensualPts: 0.2,
      },
      {
        parqueId: 'parque-nl',
        parqueNombre: 'GuadalupePark I',
        region: 'Norte',
        metrosRentados: 92_213,
        metrosRentables: 95_000,
        porcentajeOcupacion: 97.1,
        variacionMensualPts: 0.4,
      },
      {
        parqueId: 'parque-bajio',
        parqueNombre: 'Parques del Bajío - Silao',
        region: 'Bajío',
        metrosRentados: 31_900,
        metrosRentables: 40_600,
        porcentajeOcupacion: 78.6,
        variacionMensualPts: -0.5,
      },
    ],
    mrrTrend,
    mrrForecast,
